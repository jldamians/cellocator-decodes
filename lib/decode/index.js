        ...
        init: function(trama, ip, port) {
            ...
            return {
                database: function() {
                    ...
                    var gpsdatetime = helper.lpad(_now.year(), 2)+'-'+helper.lpad(_now.month(), 2)+'-'+this.lastGpsFix().dayOfMonth()+' '+this.lastGpsFix().hours()+':'+this.lastGpsFix().minutes()+':'+this.utcTimeSeconds();
