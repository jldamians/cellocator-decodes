...
var HARDWARE = require('./constants/').HARDWARE;
var CUSTOM_DATE = require('./constants/').CUSTOM_DATE;
var TIME_KEY = require('./constants/').TIME_KEY;
...
(function() {
    ...
    this.utcTimeSeconds = function() {
        ...
        if ( byte63 ) {
            /*returned = '00' + base.hexToDec(byte63) ;
            returned = returned.substr(-2);*/
    ...
    this.utcTimeMinutes = function() {
        ...
        if ( byte64 ) {
            /*returned = '00' + base.hexToDec(byte64) ;
            returned = returned.substr(-2);*/
    ...
    this.utcTimeHours = function() {
        ...
        if ( byte65 ) {
            /*returned = '00' + base.hexToDec(byte65) ;
            returned = returned.substr(-2);*/
    ...
    this.utcTimeDay = function() {
        ...
        if ( byte66 ) {
            /*returned = '00' + base.hexToDec(byte66);
            returned = returned.substr(-2);*/
    ...
    this.utcTimeMonth = function() {
        ...
        if ( byte67 ) {
            /*returned = '00' + base.hexToDec(byte67);
            returned = returned.substr(-2);*/
