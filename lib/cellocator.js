...
Cellocator.prototype.database = function() {
    ...
    var _versionnum     = this.unitsHardwareVersion().version(); 
    var _ip             = this.ip;
...
Cellocator.prototype.unitsHardwareVersion = function() {
    ...
    _modem  = utin.binToDec(byte13.substr(0, 3)) ;
    _modelo = utin.binToDec(byte13.substr(3, 5)) ;
...
Cellocator.prototype.unitsInputOutputStatus4stByte = function() {
    ...
    return {
        ...
        plmn: function() {
            return util.hexToDec(this.unitsStatusCurrentGsmOperator().currentGsmOperator1stNibble()+''+this.currentGsmOperator()+''+byte25) ;
        }
    }
}
