...
var Ack = (function(){
	...
	* @param {integer} command: correlativo de las veces que se va ejecutando un comando
	* @param {integer} message: messageNumerator de la trama recibida (consultar modulo "/decode")
	* @return {Buffer}
	*/
	function _genericAcknowledgeMessage(UID, command, message) {
		var unitId = null;
		...
		commandNumerator = command > 255 ? 0 : command;
