...
(function(){
	this.genericCommands = function(unit, numerator, codefield, firsttwice) {
		this.unitId = '00000000' + base.decToHex(unit);
		...
		this.commandNumerator = '00' + base.decToHex(this.commandNumerator);
	...
	*/
	this.genericAcknowledgeMessage = function(unitId, commandNumerator, messageNumerator) {
		this.unitId = '00000000' + base.decToHex(unitId);
		this.unitId = this.unitId.substr(-8);
		this.unitId = base.reverseHexadecimal(this.unitId);
		...
		this.messageNumeratorOfMessageReceived = '00' + base.decToHex(messageNumerator);
